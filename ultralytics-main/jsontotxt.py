...
def labelme2yolov2Seg(jsonfilePath="", resultDirPath="", classList=["clc"]):
    """
...
if __name__ == "__main__":
    jsonfilePath = "G:ultralytics\data\Annotations/"  # 要转换的json文件所在目录
    resultDirPath = "G:ultralytics\data\labels/"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["煤", "矸石"])
